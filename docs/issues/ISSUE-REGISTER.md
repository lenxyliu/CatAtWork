...
| ISSUE-027 | P0 | fixed-unverified / current-confirmed | Visual QA has no deterministic baseline/release finding contract or fail-closed release policy ([GitHub #14](https://github.com/lenxyliu/CatAtWork/issues/14)) | BC-030; TR-VISUAL-20260726-002..007 | `codex/visual-qa-gates` |
